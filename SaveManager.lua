...
local SaveManager = {} do
    ...
    SaveManager.AutoSavePath = SaveManager.Folder .. "/AutoSave"
    ...
    --// Save, Auto Save, Load, Delete, Refresh \\--
    ...
    function SaveManager:AutoSave()
        ...
        if not self.Library.Options then return end

        local configDropdown = self.Library.Options.SaveManager_ConfigList
